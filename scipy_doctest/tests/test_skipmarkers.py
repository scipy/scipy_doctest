...
from ..impl import DebugDTRunner, DTConfig, DTParser
...
class TestPseudocodeMarkers:
    ...
    def test_pseudocode_markers(self):
        ...
        test = parser.get_doctest(
            string, globs={}, name="none", filename="none", lineno=0
        )
...
class TestStopwords:
    ...
    def test_bogus_output(self):
        ...
        parser = DTParser()
        test = parser.get_doctest(
            string, globs={}, name="stopwords_bogus_output", filename="none", lineno=0
        )
...
class TestMayVary:
    ...
    def test_may_vary(self):
        ...
        parser = DTParser()
        test = parser.get_doctest(
            string, globs={}, name="may_vary_markers", filename="none", lineno=0
        )
    ...
    def test_may_vary_source(self):
        ...
        parser = DTParser()
        test = parser.get_doctest(
            string, globs={}, name="may_vary_source", filename="none", lineno=0
        )
    ...
    def test_may_vary_syntax_error(self):
        ...
        parser = DTParser()
        test = parser.get_doctest(
            string, globs={}, name="may_vary_err", filename="none", lineno=0
        )
...
def test_SKIPBLOCK():
    parser = DTParser()
    test = parser.get_doctest(
        string, globs={}, name="SKIPBLOCK test", filename="none", lineno=0
    )
